...
public class TeacherRestController {
    ...
    public Response getFiltered(@QueryParam("firstname") String firstname,
        ...
        TeacherFilterDTO filtersDTO = new TeacherFilterDTO(firstname,lastname,vat);
        Map<String, Object> criteria;
        criteria = Mapper.mapToCriteria(filtersDTO);
        List<TeacherReadOnlyDTO> readOnlyDTOS = teacherService.getAllTeachersByCriteria(criteria);
